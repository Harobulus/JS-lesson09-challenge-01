...
const assignItems = function () {
    ...
    const potluckItems = ["potato salad", "hummus", "cookies", "fruit",
     "Halloumi", "Veggie", "Mozzarella", "cheese tomato tart",
      "Zucchini noodles", "Avocado", "stuffed peppadews", "bean isreali"];
